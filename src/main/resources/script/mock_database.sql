...
insert into account(number, balance, clientId) values('12345123451234512345', 0, 1);
insert into account(number, balance, clientId) values('51111511115111151111', 0, 2);
insert into account(number, balance, clientId) values('21111211112111121111', 0, 3);
insert into account(number, balance, clientId) values('31111311113111131111', 0, 4);
insert into account(number, balance, clientId) values('41111411114111141111', 0, 5);
